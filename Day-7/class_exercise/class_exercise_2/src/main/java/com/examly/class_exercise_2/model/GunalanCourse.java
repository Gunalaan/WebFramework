...
public class GunalanCourse {
     ...
     public GunalanCourse() {

     }

     public GunalanCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
