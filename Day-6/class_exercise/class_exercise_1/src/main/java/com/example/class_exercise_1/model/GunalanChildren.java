...
public class GunalanChildren {
     ...
     public GunalanChildren() {

     }

     public GunalanChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
